...
class AdminCountdownWidgetProvider : AppWidgetProvider() {
        ...
        fun startTicking(context: Context) {
            ...
            tickingRunnable = object : Runnable {
                override fun run() {
                    ...
                    val componentName = ComponentName(appContext.packageName, AdminCountdownWidgetProvider::class.java.name)
                    val appWidgetIds = appWidgetManager.getAppWidgetIds(componentName)

                    if (appWidgetIds.isNotEmpty()) {
                        val provider = AdminCountdownWidgetProvider()
    ...
    private fun scheduleNextUpdate(context: Context) {
        ...
        val intent = Intent(context, AdminCountdownWidgetProvider::class.java).apply {
