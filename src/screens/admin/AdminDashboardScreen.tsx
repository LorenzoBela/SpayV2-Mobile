  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: t.bg }]} edges={['top', 'left', 'right']}>
      ...
      >
        ...
        {/* Master Operations & Observability Bar */}
        <View style={{ marginBottom: 18, marginTop: 4 }}>
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10, paddingHorizontal: 4 }}>
            <Text style={{ fontSize: 13, fontWeight: '700', color: t.textPrimary, letterSpacing: -0.2 }}>Core Portals</Text>
            <TouchableOpacity onPress={() => navigation.navigate('AdminMore')} activeOpacity={0.7}>
              <Text style={{ fontSize: 11, fontWeight: '700', color: t.accent }}>View All →</Text>
            </TouchableOpacity>
          </View>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ gap: 10, paddingHorizontal: 2 }}>
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.8}
            >
              <View style={{ width: 32, height: 32, borderRadius: 10, backgroundColor: 'rgba(238, 77, 45, 0.12)', justifyContent: 'center', alignItems: 'center' }}>
                <Wallet size={16} color="#ee4d2d" />
              </View>
              <View>
                <Text style={{ fontSize: 12, fontWeight: '700', color: t.textPrimary }}>Expenses</Text>
                <Text style={{ fontSize: 10, color: t.textSecondary }}>SPay & Atome</Text>
              </View>
            </TouchableOpacity>
            ...
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate('AdminIpon')}
              activeOpacity={0.8}
            >
              <View style={{ width: 32, height: 32, borderRadius: 10, backgroundColor: 'rgba(16, 185, 129, 0.12)', justifyContent: 'center', alignItems: 'center' }}>
                <PiggyBank size={16} color="#10b981" />
              </View>
              <View>
                <Text style={{ fontSize: 12, fontWeight: '700', color: t.textPrimary }}>Ipon Goals</Text>
                <Text style={{ fontSize: 10, color: t.textSecondary }}>7 Visual Themes</Text>
              </View>
            </TouchableOpacity>
            ...
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate('AdminSalary')}
              activeOpacity={0.8}
            >
              ...
              <View>
                <Text style={{ fontSize: 12, fontWeight: '700', color: t.textPrimary }}>Salary</Text>
                <Text style={{ fontSize: 10, color: t.textSecondary }}>Payday Inflow</Text>
              </View>
            </TouchableOpacity>
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.8}
            >
              <View style={{ width: 32, height: 32, borderRadius: 10, backgroundColor: 'rgba(6, 182, 212, 0.12)', justifyContent: 'center', alignItems: 'center' }}>
                <Activity size={16} color="#06b6d4" />
              </View>
              <View>
                <Text style={{ fontSize: 12, fontWeight: '700', color: t.textPrimary }}>Health</Text>
                <Text style={{ fontSize: 10, color: t.textSecondary }}>Probes & Logs</Text>
              </View>
            </TouchableOpacity>
          </ScrollView>
        </View>
